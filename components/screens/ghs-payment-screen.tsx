...
export default function GHSPaymentScreen() {
  ...
  const ghs = usd * Number(appSettings.ghs_per_usd);
  ...
  return (
    <VibeScreen>
      ...
      <View style={[styles.header, { paddingTop: topPad + 12 }]} pointerEvents="box-none">
        ...
        <Text style={styles.h1}>GHS Payment</Text>
      </View>
        ...
        <View style={styles.bigCard}>
          ...
          <View style={styles.group}>
            ...
            <View style={styles.copyRow}>
              <Text style={styles.copyValue}>{appSettings.ghs_bank_name}</Text>
              <Text style={styles.copyBtn}>COPY</Text>
            </View>
          </View>

          <View style={styles.group}>
            <Text style={styles.groupLabel}>Merchant Number</Text>
            <View style={styles.copyRow}>
              <Text style={styles.copyValueMono}>{appSettings.ghs_merchant_number}</Text>
              <Text style={styles.copyBtn}>COPY</Text>
            </View>
          </View>
          ...
          <View style={styles.group}>
            ...
            <View style={styles.copyRow}>
              <Text style={styles.copyValue}>{appSettings.ghs_account_name}</Text>
              <Text style={styles.copyBtn}>COPY</Text>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  copyBtn: { color: vibeColors.secondary, fontWeight: '900', fontSize: 12 },
  upload: { gap: 12 },
  uploadLabel: {
    color: vibeColors.muted,
    fontSize: 10,
